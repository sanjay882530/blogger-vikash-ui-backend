...
function Signup() {
  ...
  return (
    <MDBContainer fluid className='d-flex align-items-center justify-content-center w-60'>
      <form onSubmit={handleSubmit}>
        <MDBCard className='m-5'>
          ...
          <MDBBtn type="submit" className='mb-4 w-100 gradient-custom-4' size='lg' disabled={isSubmitting}>
            {isSubmitting ? 'Processing...' : 'Register'} {/* Change button text */}
          </MDBBtn>
